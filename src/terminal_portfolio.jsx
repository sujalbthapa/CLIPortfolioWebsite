...
function ImageViewer({ images, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-fade-in font-mono" role="dialog" aria-modal="true" aria-label="Image Gallery">
        ...
        <div className="bg-elegant-subtle px-4 py-2.5 border-b-2 border-elegant-border flex items-center justify-between">
          <div className="flex gap-2">
            <button 
              ...
              className="w-3.5 h-3.5 rounded-full bg-elegant-danger hover:scale-110 transition-transform flex items-center justify-center text-[8px] text-black font-bold"
            >
              ✕
            </button>
  ...
  return (
    <div className={`flex h-screen w-screen overflow-hidden font-mono bg-elegant-bg text-elegant-fg`} onClick={() => inputRef.current?.focus()}>
      ...
      <main className="flex flex-col flex-1 min-w-0 overflow-hidden relative bg-elegant-bg">
        <header className={`shrink-0 px-8 py-5 flex items-center justify-between border-b-2 border-elegant-border bg-elegant-bg/95 backdrop-blur-sm z-10`}>
          <div className="flex items-center gap-2">
            <div className="flex gap-2 mr-6">
              <div className="w-3 h-3 rounded-full bg-elegant-danger shadow-sm" />
              <div className="w-3 h-3 rounded-full bg-elegant-warning shadow-sm" />
              <div className="w-3 h-3 rounded-full bg-elegant-success shadow-sm" />
            </div>
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="text-[10px] uppercase tracking-widest text-elegant-primary font-bold px-3 py-1.5 border border-elegant-primary/30 rounded hover:bg-elegant-primary hover:text-white transition-all shadow-sm flex items-center gap-2"
            >
